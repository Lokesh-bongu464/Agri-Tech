...
import api from "../services/api"; // Import api service directly for signup
import { Link, useNavigate } from "react-router-dom";

const Asignup = ({ showNotification }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/alogin"); // Redirect to admin login after successful signup
    } catch (error) {
      showNotification(
